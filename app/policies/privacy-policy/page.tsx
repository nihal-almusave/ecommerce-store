        ...
        <div className="bg-gray-50 py-4">
          <div className="container mx-auto px-4">
            <nav className="text-sm text-gray-600">
              <span>Home</span> / <span className="text-black">Privacy Policy</span>
            </nav>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 mb-6">
              TANNARO operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). TANNARO is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
            </p>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Personal Information We Collect or Process</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Personal Information Sources</h2>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">How We Use Your Personal Information</h2>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">How We Disclose Personal Information</h2>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Relationship with Shopify</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Third Party Websites and Links</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Children's Data</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Security and Retention of Your Information</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Your Rights and Choices</h2>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Complaints</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">International Transfers</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Changes to This Privacy Policy</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-black">Contact</h2>
            <p className="text-gray-700 mb-8">
              ...
              {' '}or contact us at 30 N Gould St ste r, Sheridan, WY, 82801, US
            </p>
          </div>
        </div>
